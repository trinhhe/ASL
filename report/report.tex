...
\end{figure}\rh{figure: why the italics?}
...
The overall speedup lies between 100 to 500$\times$ for optimisation step \opt{8}.
...
We achieved a 100 to 500$\times$ speedup on an Intel(R) Core(TM) i5-7200U and up to 16.25\% vectorized peak performance on a small dataset which fits into cache.
