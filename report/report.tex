...
\HRinline{Yes and to the bipartite part, the plot should disprove the assumption that graph padding on higher degree graph helps}
...
\HRinline{I think we should do it on big and small dataset for roofline + end-to=end speedup}
