...
\begin{figure}\centering
	\includegraphics[scale=0.59]{img/speedup[8]GraphPadding_small.pdf}
...
\begin{figure}\centering
	\includegraphics[scale=0.59]{img/speedup[8]GraphPadding_bipartite.pdf}
...
The relative speedup gain for bipartite graphs is slightly lower than in \cref{speedupGraphPaddingSmall}.
