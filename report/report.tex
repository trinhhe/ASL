...
\begin{figure}\centering
	...
	\caption{Roofline plot of optimisation steps \opt{8}, \opt{3} and the baseline \opt{1} using the small dataset.
			The rooflines are with respect to scalar / vectorized peak processor performance (2 resp. 8 flops/cycle) and the bandwidths of L1,L2,L3 and memory. Black dots represent the smallest input n. \label{rooflineEndToEndSmall}}
\end{figure}
